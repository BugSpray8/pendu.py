...
Attention ! Comme dit dans le fichier donnees.py, ne copier pas bêtement 

car selon les modifications que vous apporterez, 

le code pourrait être différent de celui ci"""
